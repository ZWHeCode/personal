...
#import "SXScanViewController.h"

@interface SXScanViewController ()

@end

@implementation SXScanViewController
    ...
    [self dismissViewControllerAnimated:YES completion:^
     {
         [timer invalidate];
//         NSLog(@"%@",stringValue);
//         UIAlertView * alert = [[UIAlertView alloc]initWithTitle:@"扫描完成" message:stringValue delegate:self cancelButtonTitle:@"取消" otherButtonTitles:nil, nil];
//         [alert show];
